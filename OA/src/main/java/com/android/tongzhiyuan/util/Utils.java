...
package com.android.tongzhiyuan.util;
...
import com.android.tongzhiyuan.act_other.LoginActivity;
import com.android.tongzhiyuan.bean.DictInfo;
...
import com.android.tongzhiyuan.dialogfragment.OneBtDialogFragment;
import com.android.tongzhiyuan.exception.NoSDCardException;
...
//                Manifest.permission.READ_PHONE_STATE);
    ...
    public static String getVersionCode(Context context) {
        ...
        try {
            versionCode = context.getPackageManager().getPackageInfo("com.android.tongzhiyuan", 0)
                    .versionName;
    ...
    public static int getStatusColor(Context context, int status) {
        int[] statusColorArr = {R.color.transparent, R.color.status_waiting, R.color.status_auditing,
